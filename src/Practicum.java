...
public class Practicum {
    ...
    public static final int MINIMUM_BONUS_WEIGHT = 10;
    public static final int COEFFICIENT_UNDER_TEN_KILOS = 10;
    public static final int COEFFICIENT_ABOVE_TEN_KILOS = 15;
    ...
    public static void main(String[] args) {
        ...
        switch (ChatCommand.valueOf(commandValue)) {
            ...
            case BONUS:
                ...
                int recycleMaterial = Integer.parseInt(scanner.nextLine());
                int bonus;
                if (recycleMaterial < MINIMUM_BONUS_WEIGHT) {
                    bonus = recycleMaterial * COEFFICIENT_UNDER_TEN_KILOS;
                } else {
                    bonus = recycleMaterial * COEFFICIENT_ABOVE_TEN_KILOS;
                }
                System.out.println("Количество бонусных баллов: " + bonus + ".");

                break;
            default:
                System.out.println("You have entered the unknown command.");
        }
